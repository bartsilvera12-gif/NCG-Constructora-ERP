...
export default function VentasPage() {
  ...
  useEffect(() => {
    ...
    getVentas().then((data) => {
      if (cancelled) return;
      // /ventas SOLO lista ventas reales (tipo_documento='venta'). Los
      // presupuestos viven en /presupuestos mientras están pendientes/rechazados,
      // y al aprobarse se convierten directamente en obra → /dashboard/proyectos.
      // Un presupuesto NUNCA aparece en /ventas, en ningún estado.
      const soloVentasReales = data.filter((v) => (v.tipo_documento ?? "venta") === "venta");
      const ordenadas = soloVentasReales.sort((a, b) => {
